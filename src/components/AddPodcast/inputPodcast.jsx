...
const inputPodcast = () => {
    ...
    const handleSubmitPodcast=async()=>{
        ...
        const data=new FormData();      //it will take all data from form
      ...
      <div className="mt-5 flex flex-col lg:flex-row items-center justify-between gap-4">
        <div className="w-full lg:w-2/6 flex items-center justify-center lg:justify-start">
            ...
            {frontImage?(
                ...
                <label 
                    htmlFor='file' 
                    className={`text-xl h-[100%] w-[100%] hover:cursor-pointer flex items-center justify-center ${Dragging? "bg-blue-200":""} hover:bg-zinc-200 transition-all duration-300`}
