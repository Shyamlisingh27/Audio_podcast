...
const DescriptionPage = () => {
  //we have to fetch particular id from backend which we have to search and which shoul be shown when clicking on that particular podcast.
  const {id} = useParams();
  ...
  return (
    <div className='px-4 lg:px-12 py-4 h-auto flex flex-col md:flex-row items-start justify-between gap-4'>
      ...
      <div className="w-4/6">
          ...
          <h4 className="mt-4">{Podcasts.description}
          </h4>
